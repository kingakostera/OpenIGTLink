...
int main(int argc, char* argv[])
{
  ...
  // Close connection (The example code never reaches to this section ...)
	...
	pointMessagePointer->SetDeviceName("PointSender"); 
  ...
  if (c & igtl::MessageHeader::UNPACK_BODY) // if CRC check is OK
    ...
    for (int i = 0; i < nElements; i ++)
      ...
      std::cerr << "================================" << std::endl;
  	  ...
  	  igtl::PointMessage::Pointer pointMessagePointer2;
	  pointMessagePointer2 = igtl::PointMessage::New();
	  pointMessagePointer2->SetDeviceName("PointReceiver");
	  ...
	  pointMessagePointer2->AddPointElement(point0);
	  pointMessagePointer2->Pack();

	  igtl::Sleep(500);
	  socket->Send(pointMessagePointer2->GetPackPointer(), pointMessagePointer2->GetPackSize());
